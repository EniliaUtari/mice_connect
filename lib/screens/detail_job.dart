...
// Mengubah detail_job menjadi StatefulWidget
class detail_job extends StatefulWidget {
  const detail_job ({Key? key}) : super(key: key);

  @override
  _DetailJobState createState() => _DetailJobState();
}

// Membuat class state untuk DetailJob
class _DetailJobState extends State<detail_job> {
  @override
